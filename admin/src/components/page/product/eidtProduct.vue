            ...
            <el-row :gutter="20">
                ...
                <el-col :span="12">
                    <div class="grid-content bg-purple">
                         ...
                         <el-form-item prop="cId" v-if="cIds.length > 0">
                               <el-select v-model="form.cId"  placeholder="请选择商品类别"  ref="catorySel">
                                    <el-option  v-for="item in cIds" :key="item.cid" :value="item.cid" :label="item.name"></el-option>
                                </el-select>
                        </el-form-item>
                    </div>
                </el-col>
           ...
           <el-row :gutter="20">
            ...
            <el-row :gutter="20">
             ...
             <el-row :gutter="20">
                <el-col :span="4">
                    <div class="grid-content bg-purple">
                        <div class="el-form-item__label">摄像头（一）</div>
                 ...
                 <el-col :span="4">
                    <div class="grid-content bg-purple">
                        <div class="el-form-item__label" style="opacity: 0">摄像头（二）</div>
                 ...
                 <el-col :span="4">
                    <div class="grid-content bg-purple">
                        <div class="el-form-item__label" style="opacity: 0">摄像头（三）</div>
                    ...
                    <div class="grid-content bg-purple">
                        <div class="el-form-item__label">车架号</div>
                         <el-form-item
                          ...
                          >
                            <el-input v-model="form.productItem.carframNum"></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    ...
                    <div class="grid-content bg-purple">
                        <div class="el-form-item__label">开票金额</div>
                         <el-form-item
                          ...
                          >
                            <el-input v-model="form.productItem.invoicePrice" ></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
            ...
            <el-row :gutter="20">
                <el-col :span="24">
                    ...
                    <upload-img 
                        @filesChange="changeVehicleCertificateImg"
                        :maxLength="3"
                        :seversImgs="carCertified"
                        :seversImgsIp="form.photoIp"
                        @delFile="delFile"
                        type="carCertified"
                        @imgLengthChange="carCertifiedLengthChange"
                    ></upload-img>
                </el-col>
                <div class="el-form-item__label" style="padding-left:10px">注：图片大小不能超过5M，超过5M自动过滤掉</div>
            </el-row>
...
export default {
    beforeRouteEnter (to, from, next) {
        if(!to.params.product){
            next({path: `/productDetail`,query:{id: to.query.id},replace: true});
        }else{
           next();
        }
    },
    ...
    created(){
        ...
        this._getCIds().then(() => {
            ...
            let form = this.$route.params.product,
                defaultAnnualEarn = form.annualEarn,
                defaultMinAnnualEarn = form.minAnnualEarn,
                defaultIsNew = form.isNew,
                defaultIsHot = form.isHot,
                defaultCid = form.category.cid;
             form.isNew = defaultIsNew.toString();
             form.isHot = defaultIsHot.toString();
             form.annualEarn = (defaultAnnualEarn*100).toFixed(2);
             form.minAnnualEarn = (defaultMinAnnualEarn*100).toFixed(2);
             form.cId = defaultCid;
            //以此种方式解决sel无法下拉更新,本意在于去除form中的getter,setter对象，因为传入的get和set并不能对应这里的model
             this.form  = Object.assign({},form);
             this.photoLength = form.photo.length;
             this.carCertified = form.productItem.carCertified;
             this.carCertifiedLength = form.productItem.carCertified.length;
    ...
    methods:{
        ...
        goBack(){
            // this.$router.push({path: `/productDetail`,query:{id: to.query.id}});
            this.$router.back();
        ...
        carCertifiedLengthChange(len){
            this.carCertifiedLength = len;
        },
        _getCIds(){
             this.cIds = [];
          return  this.$axios.get('/getCategorys').then((res) =>{
                // console.log(res)
                if(res.status === 200){
                    if(res.data.code > 0){
        ...
        _submitForm(){
            ...
            if(me.photoLength < 1){
                ...
                return;
             }else if(me.carCertifiedLength < 1){
            ...
            delete form.photo;
            delete form.productItem.carCertified;
