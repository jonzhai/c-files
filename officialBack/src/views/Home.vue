			...
			<el-col :span="4" class="userinfo">
				<el-dropdown trigger="hover">
					...
					<el-dropdown-menu slot="dropdown">
						...
						<el-dropdown-item  @click.native="log_out">退出登录</el-dropdown-item>
					</el-dropdown-menu>
				</el-dropdown>
			</el-col>
		</el-col>
		...
		methods: {
			...
			getUser(){
				this.$axios.get('getUser').then((res) =>{
					...
					if(res.status === 200){
						if(res.data.code > 0){
							this.sysUserName = res.data.data.nickName;
							this.sysUserAvatar = this.$photoIp+res.data.data.icon.src;
						}else{
							this.myAlert(res.data.message);
							return;
						}
