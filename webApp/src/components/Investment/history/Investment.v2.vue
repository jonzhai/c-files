<template>
    <div id="invesment">
        ...
        <div class="white-bg" ref="whiteBg"> </div>
...
export default {
    ...
    mounted(){
        setTimeout(() => {
            ...
            this.minTransalteY = this.$refs.bannerContainer.offsetHeight;
        },20)
    ...
    watch:{
        scrollY(newVal){
            ...
            this.$refs.whiteBg.style[transform]= `translate3d(0,${translateY}px,0)`;
            this.$refs.classifyScroll.$el.style[transform]= `translate3d(0,${translateY}px,0)`;
        }
    },
    components:{
        commonFooter,
