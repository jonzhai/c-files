        ...
        <div v-if="!noCard">
            ...
            <div class="recharge-ipt-container">
                ...
                <div class="content">
                    ...
                    <input type="text" placeholder="最少充值100元" class="recharge-ipt" v-model="money" autofocus>
                </div>
            </div>
            <div class="confirm-container">
                <div class="confirm-btn" :class="{active: isReady}" @click="rechargeImmediate">立即充值</div>
            </div>
        </div>
...
export default {
    ...
    methods:{
        ...
        toChooseCards(){
            this.$router.push({path: '/recharge/chooseBankCard'});
        },
        ...mapActions(['LOGIN'])
